...
<div id="templatemo_wrapper">
	...
	<div id="templatemo_header">
        ...
        <div style="left: 600px; position: absolute; top: 90px;">
        	<p><a href="userlogin.php">用 户 名:&nbsp;&nbsp;<?php echo $_SESSION[username]; ?></a> </p>
		</div>
        ...
        <div id="content" class="float_r">
            <div id="slider-wrapper">
                <div id="slider" class="nivoSlider">
                    <img src="images/slider/2.gif" alt="" title="This is an test pictrue"/>
                    <a href="#"><img src="images/slider/1.gif" alt="" title="This is an test pictrue" /></a>
                    <img src="images/slider/2.gif" alt="" title="This is an test pictrue"/>
                    <img src="images/slider/3.gif" alt="" title="This is an test pictrue" />
                </div>
                <div id="htmlcaption" class="nivo-html-caption">
                    <strong>这是</strong> 几张测试图片 <em><a href="#">详细信息</a>.
                </div>
            </div>
            ...
            <h1>最新推荐</h1>
            <?php
                    $sql2=mysql_query("select * from shangpin where tuijian='1' order by id desc limit 0,6",$conn);
            ...
            <div class="product_box">
                ...
                <a href="productdetail.php?title=<?php echo $info[title];?>"><img src="<?php echo $info[tupian];?>" width="180px" height="150px" alt="Shoes 1" /></a><?php } ?>
            ...
            <h1>居家日用</h1>
                            <?php
                    $sql2=mysql_query("select * from shangpin where type='居家日用' order by id desc limit 0,6",$conn);
                    while($info=mysql_fetch_array($sql2))
                    {
                        ?>
                <?php
            ...
            <h1>运动户外</h1>
            <?php
                    $sql2=mysql_query("select * from shangpin where type='运动户外' order by id desc limit 0,6",$conn);
                    while($info=mysql_fetch_array($sql2))
                    {
                        ?>
                <?php
            ...
            <div class="product_box">
                <p class="product_price"><?php echo $info[title];?></p>
                <a href="productdetail.html"><img src="<?php echo $info[tupian];?>" width="180px" height="150px" alt="Shoes 1" /></a><?php } ?>
                <p><?php echo $info[uname];?></p>
                <p><?php echo $info[school];?></p>
                <p class="product_price">$ <?php echo $info[price];?></p>
                <a href="productdetail.php?title=<?php echo $info[title];?>" class="detail"></a> 
            ...
            <h1>闲置书籍</h1>
            <?php
                    $sql2=mysql_query("select * from shangpin where type='闲置书籍' order by id desc limit 0,6",$conn);
                    while($info=mysql_fetch_array($sql2))
                    {
                        ?>
                <?php
