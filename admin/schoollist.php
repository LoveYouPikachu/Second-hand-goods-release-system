  ...
  <body>
    ...
    <!-- <div class="x-body">
     ...
     <!--  <button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon"></i>批量删除</button> -->
        <button class="layui-btn" onclick="x_admin_show('添加用户','./school-add.php',600,400)"><i class="layui-icon"></i>添加</button>
        ...
        <?php
          ...
          <tr>
           ...
           <!--  <td><?php echo "$info[id]";  ?></td> -->
            ...
            <td class="td-manage">
              <a title="编辑"  onclick="x_admin_show('编辑','school-edit.php?id=<?php echo $info[id];?>',600,400)" href="javascript:;">
                <i class="layui-icon">&#xe642;</i>
              </a>
              <a title="删除" href="school-del.php?id=<?php echo $info[id];?>">
                <i class="layui-icon">&#xe640;</i>
              </a>
            </td>
          </tr>
