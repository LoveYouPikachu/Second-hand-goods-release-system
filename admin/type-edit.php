...
<html>
  ...
  <body>
    <div class="x-body">
    <?php
         $sql=mysql_query("select* from type where id=$_GET[id]",$conn);
         $info=mysql_fetch_array($sql);
       ?>
        <form class="layui-form" method="post" action="type-edit-ok.php">
          <div class="layui-form-item">
              <label for="L_email" class="layui-form-label">
                  <span class="x-red">*</span>类型编号
              </label>
              <div class="layui-input-inline">
                  <input type="text" name="typeid" class="layui-input" value="<?php echo $info[typeid];?>">
              </div>
          </div>
          <div class="layui-form-item">
