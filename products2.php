...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
        ...
        <div id="content" class="float_r">
        	<h2> 商品列表</h2>
            <?php
            $sql2=mysql_query("select * from shangpin where title like '%$_POST[keyword]%' or content like '%$_POST[keyword]%' or school like '%$_POST[keyword]%' or type like '%$_POST[keyword]%' or price like '%$_POST[keyword]%' or addtime like '%$_POST[keyword]%'",$conn);
